    ...
    public class HandTrackablePrefab : MonoBehaviour, IHand2D
    {
        ...
        { 
            ...
            for (var p = 0; p < 4; ++p)
            {
                ...
                var posX = mirrorX * (vertexPosX[p] - centerX + image.OffsetX) * adjustment * ratio;
                var posY = mirrorY * (vertexPosY[p] - centerY + image.OffsetY) * adjustment * ratio;
                var posZ = handPosZ;
            ...
            var textPosX = mirrorX * (hand.Center.x - centerX + image.OffsetX) * adjustment * ratio;
            var textPosY = mirrorY * (hand.Center.y - centerY + image.OffsetY) * adjustment * ratio;
