...
public class SelectUIScript : MonoBehaviour, UIScript
{
	...
	[SerializeField] Button CardPrintSelect;
	[SerializeField] Button FilmPrintSelect;
	...
	void Start()
	{
		...
		CardPrintSelect.onClick.AddListener(() => { PlayerPrefs.SetString("printType", "card"); StartPhoto(scrollIndex); });
		FilmPrintSelect.onClick.AddListener(() => { PlayerPrefs.SetString("printType", "film"); StartPhoto(scrollIndex); });
	}
